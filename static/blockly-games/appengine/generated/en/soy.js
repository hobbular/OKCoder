...
BlocklyGames.soy.levelLinks = function(opt_data, opt_ignored, opt_ijData) {
  var output = ' &nbsp; ';
  var iLimit159 = opt_data.maxLevel + 1;
  for (var i159 = 1; i159 < iLimit159; i159++) {
    output += ' ' + ((i159 == opt_data.level) ? '<span class="level_number level_done" id="level' + soy.$$escapeHtml(i159) + '">' + soy.$$escapeHtml(i159) + '</span>' : (i159 == opt_data.maxLevel) ? '<a class="level_number" id="level' + soy.$$escapeHtml(i159) + '" href="?lang=' + soy.$$escapeHtml(opt_data.lang) + '&level=' + soy.$$escapeHtml(i159) + soy.$$escapeHtml(opt_data.suffix) + '">' + soy.$$escapeHtml(i159) + '</a>' : '<a class="level_dot" id="level' + soy.$$escapeHtml(i159) + '" href="?lang=' + soy.$$escapeHtml(opt_data.lang) + '&level=' + soy.$$escapeHtml(i159) + soy.$$escapeHtml(opt_data.suffix) + '"></a>');
  }
  return output;
};
if (goog.DEBUG) {
...
BlocklyGames.soy.abortDialog = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="dialogAbort" class="dialogHiddenContent">This level is extremely difficult. Would you like to skip it and go onto your partner evaluations?<div id="dialogAbortButtons" class="farSide" style="padding: 1ex 3ex 0"><button id="abortCancel">Cancel</button><button id="abortOk" class="secondary">OK</button></div></div>';
};
if (goog.DEBUG) {
