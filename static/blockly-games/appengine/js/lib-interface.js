...
BlocklyInterface.importInterpreter = function() {
  ...
  script.setAttribute('src', '/static/blockly-games/appengine/third-party/JS-Interpreter/compiled.js');
...
BlocklyInterface.importPrettify = function() {
  ...
  link.setAttribute('href', '/static/blockly-games/appengine/common/prettify.css');
  document.head.appendChild(link);
  var script = document.createElement('script');
  script.setAttribute('type', 'text/javascript');
  script.setAttribute('src', '/static/blockly-games/appengine/common/prettify.js');
  document.head.appendChild(script);
};
